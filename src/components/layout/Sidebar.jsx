...
const NAV_ITEMS = [
  ...
  { key: "moderacion",  path: "/moderacion",   label: "Moderación",         dot: "bg-slate-300", roles: ["moderator"], icon: <ModeracionIcon />  },
  { key: "suscriptores",path: "/suscriptores", label: "Suscriptores",       dot: "bg-slate-300", roles: ["moderator"], icon: <SuscriptoresIcon />},
  { key: "reportes",    path: "/reportes",     label: "Reportes",           dot: "bg-slate-300", roles: ["moderator"], icon: <ReportesIcon />    },
  { key: "gestion",     path: "/gestion",      label: "Gestión Admin",      dot: "bg-amber-500", roles: ["admin"],     icon: <GestionIcon />     },
  { key: "categorias",  path: "/categorias",   label: "Categorías de Mapa", dot: "bg-slate-300", roles: ["admin"],     icon: <CategoriasIcon />  },
  { key: "ajustes",     path: "/ajustes",      label: "Ajustes",            dot: "bg-slate-300", roles: ["admin"],     dividerBefore: true, icon: <AjustesIcon /> },
];
...
export default function Sidebar({ collapsed, setCollapsed }) {
  ...
  return (
   // src/components/layout/Sidebar.jsx  (solo el return, imports y lógica igual)
